...
export class BoardArticleService {
    ...
    public async getBoardArticle(memberId: ObjectId, articleId: ObjectId): Promise<BoardArticle> {
        ...
        if (memberId) {
            ...
            // meLiked
            const likeInput = { memberId: memberId, likeRefId: articleId, likeGroup: LikeGroup.ARTICLE };//@ts-ignore
    ...
    public async likeTargetBoardArticle(memberId: ObjectId, likeRefId: ObjectId): Promise<BoardArticle> {//@ts-ignore
                ...
                { $sort: sort },
                {
                    $facet: {
                        list: [
                            ...
                            { $limit: input.limit },
                            lookupMember, // article yaratgan odamni malumotlarini mamber Dataga joylanyabdi
                            { $unwind: '$memberData' },
                        ],
                        metaCounter: [{ $count: 'total' }],
                    },
